...
(function() {
  define(['jquery', 'jqm', 'backbone', 'underscore', 'marionette', 'Meshable', 'Events', 'goog!visualization,1,packages:[corechart,geochart,gauge]'], function($, jqm, Backbone, _, Marionette, Meshable, Events) {
