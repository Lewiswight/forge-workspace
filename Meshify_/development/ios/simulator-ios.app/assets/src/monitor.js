...
(function() {
  var Pname, child, dir, email, folder, forever, i, instances, server, spinUp, trys, _i;
  ...
  spinUp = function(name) {
    ...
    child[i].on("exit", function() {
      ...
      return console.log("one of your " + Pname + " processes has exited permanently");
    });
    return child[i].start();
  };

  for (i = _i = 0; 0 <= instances ? _i <= instances : _i >= instances; i = 0 <= instances ? ++_i : --_i) {
    spinUp(i);
  }
