...
(function() {
  define(['jquery', 'jqm', 'backbone', 'underscore', 'marionette', 'Meshable', 'Events'], function($, jqm, Backbone, _, Marionette, Meshable, Events) {
    ...
    Meshable.vent.on("goto:units", function(refresh, routerObj) {
      ...
      forge.topbar.show(function() {}, console.log("hi", function(e) {
        return console.log(e);
      }));
      forge.tabbar.show(function() {}, console.log("hi", function(e) {
        return console.log(e);
      }));
      $("body").addClass('ui-disabled');
      $.mobile.showPageLoadingMsg("a", "Loading", false);
    ...
    showResults = function() {
      ...
      if (Meshable.current_units.size() === 2 && (typeof Meshable.current_units.at(1).attributes.macaddress !== void 0)) {
